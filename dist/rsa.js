...
class RSA {
    ...
    *  @returns [public key, private key]
    ...
    static async generateKeyPair() {
        ...
        const pub_base64 = (0, helper_1.arrayBufferToBase64)(spki_pub);
        const priv_base64 = (0, helper_1.arrayBufferToBase64)(pkcs8_priv);
    ...
    static async importPublicKey(base64) {
        const spki = (0, helper_1.base64ToArrayBuffer)(base64);
    ...
    static async importPrivateKey(base64) {
        const pkcs8 = (0, helper_1.base64ToArrayBuffer)(base64);
    ...
    static async encrypt(publicKey, plaintext) {
        ...
        return (0, helper_1.arrayBufferToBase64)(ciphertext);
    }
    /**
